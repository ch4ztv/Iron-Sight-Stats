(function (window) {
  ...
  function renderMatchupSection() {
    ...
    ui.renderSectionMount('matchup', shell.wrapper);
  }

  window.ISSSections = window.ISSSections || {};
  window.ISSSections['matchup'] = renderMatchupSection;
})(window);
