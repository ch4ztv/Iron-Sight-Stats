(function (window) {
  ...
  function renderBettingSection() {
    ...
    ui.renderSectionMount('betting', shell.wrapper);
  }

  window.ISSSections = window.ISSSections || {};
  window.ISSSections['betting'] = renderBettingSection;
})(window);
